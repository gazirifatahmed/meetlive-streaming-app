...
class ToppkhostrankingMonthly extends GetView<RankingController> {
  const ToppkhostrankingMonthly({super.key});
                            ...
                            children: [
                              CastonRankingcard(
                                frame: second['sender']
                                    ...
                                    : DecorationImage(
                                        image: NetworkImage(
                                          ImageHelper.getImageUrl('${second['sender']['asset_purchase_history2']['asset']['asset']}'),
                                        ),
                                        fit: BoxFit.cover,
                                      ),
                                coin: '${second['total_coin']}',
                                profileImage:
                                    ImageHelper.getImageUrl('${second['sender']['profile_image']}'),
                          ...
                          children: [
                            CastonRankingcard(
                              frame: first['sender']
                                  ...
                                  : DecorationImage(
                                      image: NetworkImage(
                                        ImageHelper.getImageUrl('${first['sender']['asset_purchase_history2']['asset']['asset']}'),
                                      ),
                                      fit: BoxFit.cover,
                                    ),
                              coin: '${first['total_coin']}',
                              profileImage:
                                  ImageHelper.getImageUrl('${first['sender']['profile_image']}'),
                            ...
                            children: [
                              CastonRankingcard(
                                frame: third['sender']
                                    ...
                                    : DecorationImage(
                                        image: NetworkImage(
                                          ImageHelper.getImageUrl('${third['sender']['asset_purchase_history2']['asset']['asset']}'),
                                        ),
                                        fit: BoxFit.cover,
                                      ),
                                coin: '${third['total_coin']}',
                                profileImage:
                                    ImageHelper.getImageUrl('${third['sender']['profile_image']}'),
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: item['sender']
                                    ...
                                    : DecorationImage(
                                        image: NetworkImage(
                                          ImageHelper.getImageUrl('${item['sender']['asset_purchase_history2']['asset']['asset']}'),
                                        ),
                                        fit: BoxFit.cover,
                                      ),
                              ),
                            ...
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl:
                                      ImageHelper.getImageUrl("${item['sender']['profile_image']}"),
                                  fit: BoxFit.cover,
