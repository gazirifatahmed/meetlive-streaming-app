...
class ToppkhostrankingWeekly extends GetView<RankingController> {
  const ToppkhostrankingWeekly({super.key});
      ...
      body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            return ListView.builder(
              itemCount: controller.weeklyRanking.length,
              itemBuilder: (BuildContext context, int index) {
                if (index == 0) {
                  final first = controller.weeklyRanking[0];
                  final second = controller.weeklyRanking.length > 1
                      ? controller.weeklyRanking[1]
                      : null;
                  final third = controller.weeklyRanking.length > 2
                      ? controller.weeklyRanking[2]
                      : null;
