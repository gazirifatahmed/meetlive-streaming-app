...
class FollowerList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 🔹 Page load hole data fetch koro
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: TextFormField(
              onChanged: (value) {
                store1controller.searchByUserId(value); // Real-time search
              },
            ...
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  var follower = store1controller.filteredFollowerList[index];
                  return GestureDetector(
                    onTap: () {
                      storeController.sendingAsset(
